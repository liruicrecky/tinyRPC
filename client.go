...
type Client struct {
	...
	shutdown bool // server has told to stop
}
...
func (client *Client) Go(serviceMethod string, args interface{}, reply interface{},
	done chan *Call, ttl time.Duration) *Call {
...
func (client *Client) CallWithTimeout(serviceMethod string, args interface{}, reply interface{}, ttl time.Duration) error {
